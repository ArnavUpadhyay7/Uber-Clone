...
router.post("/register", [
  ...
  body("vehicle.palte").isLength({ min: 3 }).withMessage('Plate must have atleast 6 letters'),
...
router.get("/profile", authMiddleware.authUser, captainController.getProfile);
